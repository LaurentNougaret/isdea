<section id="content1" class="tab-content">
    ...
    <div class="row justify-content-between">
        ...
        <div class="form-group col-md-4">
            ...
            <input id="" type="text" placeholder="" class="form-control" name="project_content[]" value="{{ $result->content[1] }}">
    ...
    <div class="row justify-content-center">
        <div class="form-group col-md-12">
            ...
            <input id="" type="text" placeholder="" class="form-control middle_textarea" name="project_content[]" value="{{ $result->content[3] }}">
    ...
    <div class="row justify-content-center">
        <div class="form-group col-md-12">
            ...
            <input id="" type="text" placeholder="" class="form-control middle_textarea" name="project_content[]" value="{{ $result->content[4] }}">
            <p>@lang('form.300.sign')</p>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="form-group col-md-12">
            ...
            <textarea id=""  placeholder="" class="form-control high_textarea" name="project_content[]">{{ $result->content[5] }}</textarea>
    ...
    <div class="row justify-content-center">
        <div class="form-group col-md-12">
            ...
            <textarea id=""  placeholder="" class="form-control high_textarea" name="project_content[]">{{ $result->content[6] }}</textarea>
            <p>@lang('form.500.sign')</p>
        </div>
    </div>
</section>