...
<!--						--><?php //echo $result->content[16]; ?><!--<br/>-->
<!--                        <br/>-->
<!--					--><?php //endif; ?>
<!--                    <h5>--><?php //echo trans('form.evolution.candidacy')?><!--</h5>-->
<!--					--><?php //if( $result->content[17] != '') : ?>
<!--						--><?php //echo $result->content[17]; ?><!--<br/>-->
<!--                        <br/>-->
<!--					--><?php //endif; ?>
...
<!--						--><?php //echo $result->content[19]; ?><!--<br/>-->
<!--                        <br/>-->
<!--					--><?php //endif; ?>
<!--                    <h5>--><?php //echo trans('form.evolution.candidacy')?><!--</h5>-->
<!--					--><?php //if( $result->content[20] != '') : ?>
<!--						--><?php //echo $result->content[20]; ?><!--<br/>-->
<!--                        <br/>-->
<!--					--><?php //endif; ?>
