...
class AdminController extends Controller
{
    ...
    public function __construct(PDFRepository $project)
    {
    ...
    public function generatePDF(Result $result)
    {
        ...
        $stylesheet = file_get_contents('app.css');
        ...
        <head>
            ...
            <style>
                ...
                .form-group{font-size: 10px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px; }
                .avis{background: #DCE6F1; padding: 10px; padding-top: 0; padding-bottom: 10px; margin-top: 5px; margin-bottom: 5px;}
                .domaine{background: #D9D9D9; padding: 10px; padding-top: 0; padding-bottom: 10px; margin-top: 5px; margin-bottom: 5px;}
        ...
        <table width="100%" class="" style=" font-family:Verdana;">
            <tr style="height:150px;">
                <td  width="10%" style="text-align:left; font-size: 11pt;color:#7f7f7f;font-family:"Century Gothic", CenturyGothic, AppleGothic, sans-serif;"><?php echo stripslashes($projet->numero); ?>
                </td>
                ...
                <?php echo stripslashes($projet->projet); ?>
                </td>
            </tr>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group"  style="height: 100px;padding:0px 10px;">
                    ...
                    <strong>Mandataire :</strong> <?php echo stripslashes($projet->mandataire); ?><br/><br/>
